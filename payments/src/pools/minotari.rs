//! Minotari Miner API integration (for tari_only mode)
//!
//! The minotari_miner can run as a stratum server for external miners.
//! This module provides API access to miner statistics and share data.
...
/// Minotari Miner API client
pub struct MinotariMinerApi {
    api_url: String,
    client: reqwest::Client,
}

impl MinotariMinerApi {
    /// Create a new Minotari Miner API client
    /// Default API is typically at http://127.0.0.1:18084
...
#[async_trait]
impl PoolApi for MinotariMinerApi {
