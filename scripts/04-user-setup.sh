...
# Pool directories
run_cmd mkdir -p ${CKPOOL_BTC_DIR}/{bin,logs}
run_cmd mkdir -p ${CKPOOL_BCH_DIR}/{bin,logs}
run_cmd mkdir -p ${CKPOOL_DGB_DIR}/{bin,logs}
run_cmd mkdir -p ${MONERO_STRATUM_DIR}/{bin,logs}
run_cmd mkdir -p ${TARI_MINER_DIR}/bin
run_cmd mkdir -p ${TARI_MERGE_DIR}/bin
